...
| #19 | Observation, exact remote status, timeout/interruption semantics; process tests and live timeout/Ctrl-C | In progress; see [#19 plan](19-exec-observation.md) |
