...
| #17 | Private result storage, scoped permissions, pinned working runner/document, manifest v4; offline checks, reviewed live plan and storage enforcement evidence | Not started |
