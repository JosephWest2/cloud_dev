...
| #20 | Complete S3 retrieval/exports with cloud-only recovery; binary/checksum, missing/denied/corrupt data and post-down recovery | In progress; see [#20 plan](20-durable-logs.md) |
